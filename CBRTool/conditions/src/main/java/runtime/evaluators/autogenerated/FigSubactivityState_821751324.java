...
public class FigSubactivityState_821751324 extends AtLeastOneConditionEvaluator {
	private Object currentObject;
	private String clsName;

	public FigSubactivityState_821751324(String clsName) {
 			...
 			for (Iterator<WeakReference<Object>> it = objectsList.iterator();it.hasNext();) {
 				...
 				if (object.isEnqueued())
 					...
 					fh.setCurrentObject(currentObject);
						...
						setFillColorFigSubactivityState_821751324_0(V1);
						setFillColorFigSubactivityState_821751324_1(V1);
				} 
			}
		}
	}

 private void setFillColorFigSubactivityState_821751324_0(Integer V1) {

		String pathCondition = "setFillColorFigSubactivityState_821751324_0";
		if(V1 == null){
 ...
 private void setFillColorFigSubactivityState_821751324_1(Integer V1) {

		String pathCondition = "setFillColorFigSubactivityState_821751324_1";
		if(V1 == null){
		 Character val = values.get(pathCondition);
		 if (val.equals('U'))
		 values.put(pathCondition, 'U');
