...
public class FigActionState_1994787237 extends AtLeastOneConditionEvaluator {
	private Object currentObject;
	private String clsName;

	public FigActionState_1994787237(String clsName) {
 			...
 			for (Iterator<WeakReference<Object>> it = objectsList.iterator();it.hasNext();) {
 				...
 				if (object.isEnqueued())
 					...
 					fh.setCurrentObject(currentObject);
						...
						setFilledFigActionState_1994787237_0(V1);
						setFilledFigActionState_1994787237_1(V1);
				} 
			}
		}
	}

 private void setFilledFigActionState_1994787237_0(Integer V1) {

		String pathCondition = "setFilledFigActionState_1994787237_0";
		if(V1 == null){
 ...
 private void setFilledFigActionState_1994787237_1(Integer V1) {

		String pathCondition = "setFilledFigActionState_1994787237_1";
		if(V1 == null){
		 Character val = values.get(pathCondition);
		 if (val.equals('U'))
		 values.put(pathCondition, 'U');
