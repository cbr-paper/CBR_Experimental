...
public class FigPartition_1807265930 extends AtLeastOneConditionEvaluator {
 			...
 			for (Iterator<WeakReference<Object>> it = objectsList.iterator();it.hasNext();) {
 				...
 				if (object.isEnqueued())
 					...
 					fh.setCurrentObject(currentObject);
						...
						String sV2 = expression("nameFig._filled","boolean");
						Integer V2 = !sV2.isEmpty() ? parseBoolean(sV2) : null;

						setFilledFigPartition_1807265930_3(V2);
						setFilledFigPartition_1807265930_2(V2);
						setFilledFigPartition_1807265930_0(V1);
						setFilledFigPartition_1807265930_1(V1);
				} 
			}
		}
	}

 private void setFilledFigPartition_1807265930_3(Integer V2) {
 ...
 private void setFilledFigPartition_1807265930_2(Integer V2) {
 ...
 private void setFilledFigPartition_1807265930_0(Integer V1) {
 ...
 private void setFilledFigPartition_1807265930_1(Integer V1) {
