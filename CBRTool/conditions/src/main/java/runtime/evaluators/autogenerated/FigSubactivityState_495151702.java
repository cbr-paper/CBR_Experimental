...
public class FigSubactivityState_495151702 extends AtLeastOneConditionEvaluator {
	private Object currentObject;
	private String clsName;

	public FigSubactivityState_495151702(String clsName) {
 			...
 			for (Iterator<WeakReference<Object>> it = objectsList.iterator();it.hasNext();) {
 				...
 				if (object.isEnqueued())
 					...
 					fh.setCurrentObject(currentObject);
						...
						setFilledFigSubactivityState_495151702_1(V1);
						setFilledFigSubactivityState_495151702_0(V1);
				} 
			}
		}
	}

 private void setFilledFigSubactivityState_495151702_1(Integer V1) {

		String pathCondition = "setFilledFigSubactivityState_495151702_1";
		if(V1 == null){
 ...
 private void setFilledFigSubactivityState_495151702_0(Integer V1) {

		String pathCondition = "setFilledFigSubactivityState_495151702_0";
		if(V1 == null){
		 Character val = values.get(pathCondition);
		 if (val.equals('U'))
		 values.put(pathCondition, 'U');
