...
public class FigPartition_1480666308 extends AtLeastOneConditionEvaluator {
 			...
 			for (Iterator<WeakReference<Object>> it = objectsList.iterator();it.hasNext();) {
 				...
 				if (object.isEnqueued())
 					...
 					fh.setCurrentObject(currentObject);
						...
						setFillColorFigPartition_1480666308_1(V1);
						setFillColorFigPartition_1480666308_5(V2);
						setFillColorFigPartition_1480666308_3(V2, V3, V4);
				} 
			}
		}
	}

 private void setFillColorFigPartition_1480666308_1(Integer V1) {
 ...
 private void setFillColorFigPartition_1480666308_5(Integer V2) {
 ...
 private void setFillColorFigPartition_1480666308_3(Integer V2, Integer V3, Integer V4) {
