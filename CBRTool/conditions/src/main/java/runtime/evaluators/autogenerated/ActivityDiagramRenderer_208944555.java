 			...
 			for (Iterator<WeakReference<Object>> it = objectsList.iterator();it.hasNext();) {
 				...
 				if (object.isEnqueued())
 					...
 					fh.setCurrentObject(currentObject);
						...
						String sV1 = expression("[org.argouml.uml.diagram.state.ui.StateDiagramRenderer.$assertionsDisabled","boolean");
						Integer V1 = !sV1.isEmpty() ? parseBoolean(sV1) : null;

						getFigNodeForActivityDiagramRenderer_208944555_1(V1);
				} 
			}
		}
	}

 private void getFigNodeForActivityDiagramRenderer_208944555_1(Integer V1) {
