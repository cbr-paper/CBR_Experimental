...
public class FigSubactivityState_1501940205 extends AtLeastOneConditionEvaluator {
	private Object currentObject;
	private String clsName;

	public FigSubactivityState_1501940205(String clsName) {
 			...
 			for (Iterator<WeakReference<Object>> it = objectsList.iterator();it.hasNext();) {
 				...
 				if (object.isEnqueued())
 					...
 					fh.setCurrentObject(currentObject);
						...
						setLineColorFigSubactivityState_1501940205_1(V1);
						setLineColorFigSubactivityState_1501940205_0(V1);
				} 
			}
		}
	}

 private void setLineColorFigSubactivityState_1501940205_1(Integer V1) {

		String pathCondition = "setLineColorFigSubactivityState_1501940205_1";
		if(V1 == null){
 ...
 private void setLineColorFigSubactivityState_1501940205_0(Integer V1) {

		String pathCondition = "setLineColorFigSubactivityState_1501940205_0";
		if(V1 == null){
		 Character val = values.get(pathCondition);
		 if (val.equals('U'))
		 values.put(pathCondition, 'U');
