...
public class FigObjectFlowState_1457021406 extends AtLeastOneConditionEvaluator {
	private Object currentObject;
	private String clsName;

	public FigObjectFlowState_1457021406(String clsName) {
 			...
 			for (Iterator<WeakReference<Object>> it = objectsList.iterator();it.hasNext();) {
 				...
 				if (object.isEnqueued())
 					...
 					fh.setCurrentObject(currentObject);
						...
						setFillColorFigObjectFlowState_1457021406_1(V1);
						setFillColorFigObjectFlowState_1457021406_0(V1);
				} 
			}
		}
	}

 private void setFillColorFigObjectFlowState_1457021406_1(Integer V1) {

		String pathCondition = "setFillColorFigObjectFlowState_1457021406_1";
		if(V1 == null){
 ...
 private void setFillColorFigObjectFlowState_1457021406_0(Integer V1) {

		String pathCondition = "setFillColorFigObjectFlowState_1457021406_0";
		if(V1 == null){
		 Character val = values.get(pathCondition);
		 if (val.equals('U'))
		 values.put(pathCondition, 'U');
